...
function enableNotifications() {
  if (!("Notification" in window)) {
    ...
    new Notification("Student Zen", { body: "You're all set! We'll remind you to check in daily." });
